...
import { toDomain as taskToDomain, toRow as taskToRow } from "../../../../infrastructure/sqlite/mappers/task.mapper.ts"
import { toDomain as profileToDomain, toRow as profileToRow } from "../../../../infrastructure/sqlite/mappers/profile.mapper.ts"
import { toDomain as progressionToDomain, toRow as progressionToRow } from "../../../../infrastructure/sqlite/mappers/progression.mapper.ts"
...
describe("progression mapper round-trip", () => {
  ...
  it("computes level=1 for zero xp", () => {
    const row = progressionToRow({ profileId: "p1", totalXp: 0, updatedAt: "now" })
