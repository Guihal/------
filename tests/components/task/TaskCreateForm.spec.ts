...
const TaskCreateForm = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    watch(() => props.suggestedComplexity, (val: "tiny" | "small" | "medium" | "large" | null | undefined) => {
      if (val) {
    ...
    return () =>
      h("form", { class: "create-form", "data-testid": "create-task-form", onSubmit: (e: Event) => { e.preventDefault(); handleSubmit() } }, [
        ...
        h("div", { class: "field" }, [
          ...
          titleError.value ? h("span", { class: "error" }, titleError.value) : null,
        ]),
        h("div", { class: "field" }, [
        ...
        h("div", { class: "field" }, [
          ...
          h("select", {
            ...
            onChange: (e: Event) => { priority.value = (e.target as HTMLSelectElement).value as TaskPriority },
          }, [
        ...
        h("div", { class: "field" }, [
          ...
          h("input", {
            ...
            value: dueAt.value,
            onInput: (e: Event) => { dueAt.value = (e.target as HTMLInputElement).value },
          }),
        ]),
        h("div", { class: "field" }, [
          ...
          h("select", {
            ...
            onChange: (e: Event) => { complexity.value = (e.target as HTMLSelectElement).value as "tiny" | "small" | "medium" | "large" },
          }, [
          ...
          complexitySource.value === "suggested" ? h("span", { class: "badge-suggested" }, "Suggested") : null,
        ]),
        h("div", { class: "form-actions" }, [
          h("button", { type: "submit", class: "btn-primary", "data-testid": "btn-submit" }, "Create"),
          h("button", { type: "button", class: "btn-secondary", "data-testid": "btn-cancel", onClick: () => emit("cancel") }, "Cancel"),
        ]),
      ])
  },
})
